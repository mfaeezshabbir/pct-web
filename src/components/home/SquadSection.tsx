...
export default function SquadSection() {
  ...
  return (
    <section className="squad-section py-24 bg-zinc-950 relative overflow-hidden flex flex-col justify-center">
      ...
      <div className="px-6 md:px-20 mb-12 flex flex-col md:flex-row justify-between items-end gap-6 z-10">
        <div>
          <h2 className="text-6xl md:text-8xl font-oswald text-white squad-title">
      ...
      >
        {players.map((player) => (
          ...
          >
            <GlassCard className="h-[500px] relative overflow-hidden group p-0 border-white/10 hover:border-pct-gold/50 transition-colors duration-500">
              {/* Background Gradient */}
              <div
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between z-20">
                <div className="flex justify-between items-start">
                  <span className="text-6xl font-oswald font-bold text-white/5 group-hover:text-white/20 transition-colors duration-500">
                    {player.number}
                  </span>
                  <div className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-pct-gold group-hover:border-pct-gold group-hover:text-black transition-all duration-300">
                    <ArrowRight
                      size={14}
                ...
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <h3 className="text-4xl font-oswald font-bold text-white uppercase leading-none mb-2">
                    {player.name}
                  </h3>
        ...
        <div className="min-w-[200px] snap-center flex items-center justify-center">
          <Link
            href="/players"
            className="group flex flex-col items-center gap-4 text-white hover:text-pct-gold transition-colors"
          >
